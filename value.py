...
class URLs:
    def __init__(cls):
        ...
        cls.EDIRECT_URI = "https://example.com/oauth"
        ...
        cls.auth_code_URL = f"https://kauth.kakao.com/oauth/authorize?&response_type=code&client_id={API_KEY}&redirect_uri={REDIRECT_URI}"


        ## 토큰 받기
        # 토큰 요청/갱신
        cls.OAUTH_URL = "https://kauth.kakao.com/oauth/token" 


        ## 메세지 전송 요청
        # 메세지 전송 요청 API URL
        cls.SEND_MSG_URL = "https://kapi.kakao.com/v2/api/talk/memo/default/send"
